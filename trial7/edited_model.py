...
def model(use_data=False):
    ...
    if use_data:
        time, u, y_data, eo_data, eo_coll = get_data('trial7.csv')
    ...
    def objective(params):
        ...
        K =  params[0] #0.02113214 # 0.01
        tau =  params[1] #2.3636113 # 0.08 params[1]
        A =  params[2] #0.00750496 # 0.0134 params[2]
        B =  params[3] #-1.1922    # -0.07  #params[3]
        ...
        return sse
    params0 = [0.02113,2.3636,0.0075,-1.19]
