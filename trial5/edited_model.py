...
def model(use_data=False):
    ...
    if use_data:
        time, u, y_data, eo_data, eo_coll = get_data('trial5.csv')
    ...
    def objective(params):
        ...
        K = params[0] #0.01140031 # 
        tau = params[1] # 1.96217706 # 
        A = params[2] # 0.00773434 #
        B = params[3] #  0.33601562 # 
        ...
        return sse
    params0 = [0.01140031,1.9621,0.00773434,0.336]
