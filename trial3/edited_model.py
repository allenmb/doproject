...
def model(use_data=False):
    ...
    if use_data:
        time, u, y_data, eo_data, eo_coll = get_data('trial3.csv')
    ...
    def objective(params):
        ...
        K = params[0] #0.01900147
        tau = params[1] #0.46886211
        A = params[2] #0.0095668
        B = params[3] #-1.18324343
        ...
        return sse
    params0 = [0.019,0.46886,0.0095668,-1.18324]
