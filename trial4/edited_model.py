...
def model(use_data=False):
    ...
    if use_data:
        time, u, y_data, eo_data, eo_coll = get_data('trial4.csv')
    ...
    def objective(params):
        ...
        K = params[0] #0.01104582
        tau = params[1] #2.20090865
        A = params[2] #0.00895317
        B = params[3] #0.11245834
        ...
        return sse
    params0 = [0.01104582, 2.20090865, 0.00895317, 0.11245834]
