...
def model(use_data=False):
    ...
    if use_data:
        time, u, y_data, eo_data, eo_coll = get_data('trial2.csv')
    ...
    def objective(params):
        ...
        K = params[0] #0.02501139 params[0]
        tau = params[1] #0.44387497 params[1]
        A = params[2] #0.00932205 params[2]
        B = params[3] #-1.31252441 params[3]
        ...
        return sse
    params0 = [0.02501139,0.44387497,0.00932205,-1.31252441]
